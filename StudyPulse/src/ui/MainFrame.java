...
public class MainFrame extends JFrame {
    ...
    private JButton btnSetting, btnLogout;
    
    // CHANGED: These now match the soft Pomofocus theme's dark buttons perfectly!
    private Color topbarBtnColor = new Color(164, 63, 63); 
    private Color topbarBtnHover = new Color(145, 50, 50);
    private Color activeTabColor = new Color(164, 63, 63);

    public MainFrame() {
        setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\burni\\Downloads\\18d9c5b9-d71b-4099-a92b-3b35d7fa65c6 (1).png"));
        setTitle("StudyPulse");
    ...
    private JPanel buildTopbar() {
        ...
        topbar.setBackground(currentBg);
        topbar.setBorder(BorderFactory.createEmptyBorder(6, 14, 6, 14));
        
        JLabel logo = new JLabel(" StudyPulse");
        logo.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 16));
        logo.setForeground(Color.WHITE);
        logo.setIcon(new ImageIcon("C:\\Users\\burni\\Downloads\\StudyPulse_Source\\StudyPulse\\src\\Pics\\studypulse2.png"));
        ...
        btnTimer.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        btnAccomplished.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        btnCalendar.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        btnSubjects.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        btnNotes.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        btnActivity.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        ...
        btnSetting = topbarActionBtn("Setting");
        btnLogout  = topbarActionBtn("Exit");
        btnSetting.addActionListener(e -> new SettingDialog(this, timerService).setVisible(true));
        btnLogout.addActionListener(e  -> doLogout());
        right.add(btnSetting); right.add(btnLogout);
    ...
    public void showTab(String name, JButton btn) {
        ...
        if (activeTab != null) {
            ...
            activeTab.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        }
        
        // active: solid dark pill using our dynamic activeTabColor variable
        btn.setContentAreaFilled(true);
        btn.setOpaque(true);
        btn.setBackground(activeTabColor); 
        btn.setForeground(Color.WHITE);
        btn.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
        activeTab = btn;
    }

    // THE FIXED METHOD: Fully maps the 4th color properly
    public void setThemeColor(Color bg, Color btnColor, Color btnHover, Color newTabColor) {
        currentBg = bg;
        this.topbarBtnColor = btnColor;
        this.topbarBtnHover = btnHover;
        
        // Updates the class variable
        this.activeTabColor = newTabColor; 
        
        // Forces the currently selected tab to visually update its color right now
        if (activeTab != null) {
            activeTab.setBackground(this.activeTabColor);
        }
        ...
        // Update the topbar buttons dynamically
        if (btnSetting != null) btnSetting.setBackground(btnColor);
        if (btnLogout != null) btnLogout.setBackground(btnColor);
    ...
    private JButton topbarActionBtn(String text) {
        ...
        b.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent e) { b.setBackground(topbarBtnHover); }
            public void mouseExited(java.awt.event.MouseEvent e)  { b.setBackground(topbarBtnColor); }
        });
        return b;
    }
