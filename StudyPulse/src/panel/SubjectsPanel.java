...
public class SubjectsPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        hdr.setMaximumSize(new Dimension(580, 40));
    ...
    public void refresh() {
        ...
        for (Subject s : subjects) {
            allPending.addAll(dao.getActivitiesBySubject(s.getId())
                .stream().filter(a -> !a.isCompleted()).toList());
        }
    ...
    private JPanel buildSubjectCard(Subject s) {
        ...
        addAct.setFont(new Font("Segoe UI", Font.BOLD, 11));
        ...
        hdr.add(addAct,  BorderLayout.EAST);
        card.add(hdr);
